...
namespace OpheliasOasisOtel
{
    public partial class SifremiUnuttum : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Select * from Musteriler where musteriKulAd='" + textBoxKulAd.Text.ToString() +
              "' and musteriePosta ='" + textBoxMail.Text.ToString() + "'", sql.baglan());
